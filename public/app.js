    ...
    if (questions.length === 0) {
      ...
      html += questions
        ...
        <article class="question-card ${q[CONFIG.API_FIELDS.SOLVED] ? "solved-card" : ""}">
          <h3>
            <a href="#" class="question-link" data-id="${q.Qid}">${q.question}</a>
          ...
          <div class="question-actions">
            <span>
              <button class="btn btn-play" data-id="${q.Qid}">Play</button>
              <a href="#" class="read-more" data-id="${q.Qid}">See answer</a>
            </span>
            ${
              q.userId === currentUserId
                ? `<span class="owner-actions">
                    <button class="btn btn-edit" data-id="${q.Qid}">Edit</button>
                    <button class="btn btn-delete" data-id="${q.Qid}">Delete</button>
                  </span>`
                : ""
            }
          </div>
